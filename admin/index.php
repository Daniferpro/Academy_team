...
<head>
  ...
  <div id="pcoded" class="pcoded">
      ...
      <div class="pcoded-container navbar-wrapper">
          <!--Inicio de navegador de encabezado-->
              ...
              <div class="navbar-wrapper">
                  ...
                  <div class="navbar-container container-fluid">
                      <ul class="nav-left">
                          ...
                          <!--Búsqueda del menu del encabezado-->
                          <!--<li class="header-search">
                              <div class="main-search morphsearch-search">
                                  <div class="input-group">
                                      <span class="input-group-addon search-close"><i class="ti-close"></i></span>
                                      <input type="text" class="form-control" placeholder="Haga su búsuqeda aquí">
                                      <span class="input-group-addon search-btn"><i class="ti-search"></i></span>
                                  </div>
                              </div>
                          </li> -->

                          <!--Para colocar en pantalla grande-->
                          <li>
                              <a href="#!" onclick="javascript:toggleFullScreen()" class="waves-effect waves-light">
                                  <i class="ti-fullscreen"></i><!--Para colocar en pantalla grande-->
                              </a>
                          </li>
                      </ul>
                      <!--Navegador encabezado lado  derecho -->
                      <ul class="nav-right">
                          ...
                          <!--Menú de usaurio principal derecho-->
                  ...
                  <nav class="pcoded-navbar">
                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          ...
                          <div class="p-15 p-b-0">
                              <!--Comenté buscador dentro del menú-->
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li class="pcoded-hasmenu">
                                  <a href="javascript:void(0)" class="waves-effect waves-dark">
                                      ...
                                      <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Mi academia</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                                  <ul class="pcoded-submenu">
                                      <li class=" ">
                                          <a href="accordion.html" class="waves-effect waves-dark">
                                              ...
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Mensajes</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
                                          <a href="breadcrumb.html" class="waves-effect waves-dark">
                                              ...
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Alumnos</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
                                          <a href="button.html" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Profesores</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
                                          <a href="tabs.html" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Estadísticas</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          <h5 class="m-b-10">Escritorio</h5>
                                          <p class="m-b-0">Bienvenida a Academia ShivaShakti</p>
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="#!">Escritorio</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                ...
                                                                <h6 class="text-muted m-b-0">Ganancias totales</h6>
                                                            </div>
                                                    ...
                                                    <div class="card-footer bg-c-purple">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">ver estadísticas</p>
                                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                <h4 class="text-c-blue">800</h4>
                                                                <h6 class="text-muted m-b-0">Vivos realizados</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                            ...
                                            <div class="col-xl-10 col-md-12">
                                                <!--Espacio para colocar lo que desee-->
                                                <H7><!--Lo que desee agregar --></H7>
                            
                                            </div>
                                            <div class="col-xl-4 col-md-12">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <h4 style="color: darkcyan;">Ganancias totales</h4>
                                                        <div class="row">
                                                            ...
                                                            <!--calcular el porcentaje con el mes anterior-->
                                                            <div class="col-auto">
                                                ...
                                                <div class="card quater-card">
                                                    ...
                                                    <!--se calcularan las ganancias totales de esta semana-->
                                                    <div class="card-block">
                                                        <h4 style="color: darkcyan;">Ganancias totales</h4>
                                                        <h6 class="text-muted m-b-15">Esta semana</h6>
                                                        <h4>$350</h4>
                                                        <!--Se calculan las ganancias con la semana anterior y se muestra la diferencia en positivo o negativo-->
                                                        <p class="text-muted">$350</p>
                                                        <h5>(-$87) que la semana anterior</h5>
